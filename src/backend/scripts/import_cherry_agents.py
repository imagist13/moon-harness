...
CURATION: List[Dict[str, Any]] = [
    ...
    {"name": "产品经理", "slug": "product-manager", "category": "职场办公", "featured": True,
     "tags": ["产品", "需求分析", "PRD"],
     "skills": ["pmaster", "diagram-builder", "officecli-pptx"],
    ...
    {"name": "行政", "slug": "admin-clerk", "category": "职场办公",
     "tags": ["行政", "公文", "会议"],
     "skills": ["officecli-docx", "meeting-minutes-organizer"],
     "mcp": [],
     "questions": ["帮我起草一份会议通知", "把这段会议录音整理成纪要"]},
    {"name": "HR人力资源管理", "slug": "hr-manager", "category": "职场办公",
     "tags": ["人力资源", "招聘", "制度"],
     "skills": ["officecli-docx", "official-doc-writer"],
     "mcp": ["internet_search"],
    ...
    {"name": "会计师", "slug": "accountant", "category": "职场办公",
     "tags": ["会计", "账务", "报表"],
     "skills": ["officecli-xlsx", "financial-report-minesweeper"],
     "mcp": ["database_query"],
    ...
    {"name": "金融分析师", "slug": "financial-analyst", "category": "商业分析",
     "tags": ["金融", "财报", "估值"],
     "skills": ["financial-report-minesweeper", "officecli-xlsx"],
    ...
    {"name": "数据分析师", "slug": "data-analyst", "category": "数据分析", "featured": True,
     "tags": ["数据分析", "建模", "可视化"],
     "skills": ["data-analyst-cn", "csv-pipeline", "officecli-xlsx", "data-analysis-report-generator"],
     "mcp": ["database_query", "generate_chart_tool"],
    ...
    {"name": "统计学家", "slug": "statistician", "category": "数据分析",
     "tags": ["统计", "假设检验", "回归"],
     "skills": ["csv-pipeline", "officecli-xlsx"],
