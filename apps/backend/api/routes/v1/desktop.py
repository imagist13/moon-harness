...
Windows build machine) just puts three things into that directory:
    ...
    <DESKTOP_RELEASE_DIR>/
      ...
      ├─ LumenOS_0.2.0_x64-setup.nsis.zip        # NSIS installer (updater artifact)
      └─ LumenOS_0.2.0_x64-setup.nsis.zip.sig    # matching signature (optional; the signature content can also be inlined into latest.json)
...

    {
      ...
      "platforms": {
        "windows-x86_64": {
          ...
          "url": "LumenOS_0.2.0_x64-setup.nsis.zip"
        }
      }
    }
"""
